package com.codepath.healthpact.drawer;
...
import com.codepath.healthpact.adapters.DrawableListAdapter;

public class HomeViewNavigationDrawer extends DrawerLayout {
	...
	public HomeViewNavigationDrawer(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}
 
	public HomeViewNavigationDrawer(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
 
	public HomeViewNavigationDrawer(Context context) {
		super(context);
	}
	...
	public void setupDrawerConfiguration(ListView drawerListView, int drawerItemRes, int drawerContainerRes) {
		...
		drawerNavItems = new ArrayList<HomeViewNavigationDrawer.FragmentNavItem>();

		// Set the adapter for the list view
		//drawerAdapter = new ArrayAdapter<String>(getActivity(), drawerItemRes, new ArrayList<String>());
		drawerAdapter = new DrawableListAdapter(getActivity(), new ArrayList<String>());
		this.drawerContainerRes = drawerContainerRes; 
		// Setup drawer list view and related adapter
		lvDrawer = drawerListView;
		lvDrawer.setAdapter(drawerAdapter);
		// Setup item listener
		lvDrawer.setOnItemClickListener(new HomeViewNavigationDrawerItemListener());
	...
	private class HomeViewNavigationDrawerItemListener implements ListView.OnItemClickListener {		
		@Override
